...
###################################################################################################
# Training and tests for criation of ensemple (multiplier classifier) using RTextTools R package
start_time <- Sys.time()
...
drv = dbDriver("SQLite")
con = dbConnect(drv,dbname="db_pubmed_abstracts.db")
...
# Selecting pubmed abstracts with classification probability above or equal 0.7 and class equal 1
# results_entmax = results_entmax[results_entmax$MAXENTROPY_PROB > 0.7,]
...
results_svm = results
# Selecting pubmed abstracts with classification probability above or equal 0.7 and class equal 1
# results_svm = results_svm[results_svm$SVM_PROB > 0.7,]
...
results_rf = results
# Selecting pubmed abstracts with classification probability above or equal 0.7 and class equal 1
#results_rf = results_rf[results_rf$FORESTS_PROB > 0.7,]
...
# Selecting pubmed abstracts with classification probability above or equal 0.7 and class equal 1
#results_boosting = results_boosting[results_boosting$LOGITBOOST_PROB > 0.7,]
...
##### Union of text classifications for Multiple classification  #######
